/****************************************************************************
* ITG3200_DUE.h - ITG-3200/I2C library v0.5 for Arduino                         *
...
#ifndef FIMU_ITG3200_DUE_h_DUE
#define FIMU_ITG3200_DUE_h_DUE

#include "Arduino.h"
#include <Wire.h>

//#define ITG3200_DUE_ADDR_AD0_HIGH  0x69   //AD0=1 0x69 I2C address when AD0 is connected to HIGH (VCC) - default for sparkfun breakout
#define ITG3200_DUE_ADDR_AD0_LOW   0x68   //AD0=0 0x68 I2C address when AD0 is connected to LOW (GND)
...
// One device should have pin9 (or bit0) LOW and the other should be HIGH." source: ITG3200_DUE datasheet
