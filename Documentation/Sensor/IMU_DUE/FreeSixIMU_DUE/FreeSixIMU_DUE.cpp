/*
FreeSixIMU_DUE.cpp - A libre and easy to use orientation sensing library for Arduino
...
void FreeSixIMU_DUE::init() {
  init(FIMU_ACC_ADDR, FIMU_ITG3200_DUE_DEF_ADDR, false);
}

void FreeSixIMU_DUE::init(bool fastmode) {
  init(FIMU_ACC_ADDR, FIMU_ITG3200_DUE_DEF_ADDR, fastmode);
}

void FreeSixIMU_DUE::init(int acc_addr, int gyro_addr, bool fastmode) {
  delay(5);

  // for Due
  cbi(REG_PIOB_PDSR, 12);
  cbi(REG_PIOB_PDSR, 13);
...
void FreeSixIMU_DUE::getRawValues(int16_t * raw_values) {
...
void FreeSixIMU_DUE::getValues(float * values) {  
  int16_t accval[3];
...
//
//=====================================================================================================
void FreeSixIMU_DUE::AHRSupdate(float gx, float gy, float gz, float ax, float ay, float az, float mx, float my, float mz) {
  float recipNorm;
...
void FreeSixIMU_DUE::getQ(float * q) {
  float val[9];
  getValues(val);
...
void FreeSixIMU_DUE::getEuler(float * angles) {
...
void FreeSixIMU_DUE::getAngles(float * angles) {
  float a[3]; //Euler
  getEuler(a);
...
void FreeSixIMU_DUE::getYawPitchRoll(float * ypr) {
  float q[4]; // quaternion
